...
public class GameRendererTransformer extends AsmTransformer {
    ...
    public void transform(ClassNode klass) {
        ...
        if (method == null) throw new RuntimeException("[Serta Client] Could not find method GameRenderer.getFov()");
        ...
        if (injectionCount < 2) throw new RuntimeException("[Serta Client] Failed to modify GameRenderer.getFov()");
    }
